      ...
      <Popover.Anchor asChild>
        <div className="relative w-full">
          ...
          <input
            ...
            className="h-9 w-full rounded-[8px] border border-border bg-surface pl-9 pr-16 text-sm shadow-xs transition-colors placeholder:text-muted-foreground/80 hover:border-border-strong focus-visible:border-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/35"
          />
